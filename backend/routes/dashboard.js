...
router.get("/data", auth, async (req, res) => {
    try {
        ...
        // Auto-enroll old users in missing default courses
        ...
        defaultCourses.forEach(defCourse => {
            const isEnrolled = user.enrolledCourses.some(c => c.courseId === defCourse.courseId);
            if (!isEnrolled) {
                user.enrolledCourses.push(defCourse);
                hasUpdates = true;
            }
        });
